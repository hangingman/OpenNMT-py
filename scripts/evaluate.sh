...
python translate.py -model $model -src $source -output $target.pred -beam_size 10 -batch_size 1 -alpha ${alpha} -beta ${beta} -replace_unk -verbose -gpu 3
